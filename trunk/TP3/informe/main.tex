...
\hypersetup{
  pdftitle={Orga2 - TP3 - Programación de Sistemas Operativos},
  colorlinks,
  citecolor=black,
  filecolor=black,
  linkcolor=black,
...
\vskip 10\p@
    \hbox{\mbox{%
        \hspace{3pt}%
        \fbox{\includegraphics[scale=0.5]{sub.pdf}}  % IMAGEN LOCA
        \hspace{4pt}
        }
    ...
    {\fontsize{10pt}{0pt} {\sffamily J. Enríquez - LU 36/08 - juanenriquez@gmail.com \par N. Gleichgerrcht - LU 160/08 - nicog89@gmail.com \par J. Luini - LU 106/08 - jluini@gmail.com}} \par %se pueden poner los autores
...
\tptit{Programación de S.O. en IA-32}
\res{
BLA BLA BLA BLA RESUMEN. \\
\indent BLA BLA BLA BLA RESUMEN.}

\materia{Organización del Computador II}
\keyvar{Sistemas Operativos - Kernel.asm - Bochs - IA-32} % palabras claves
